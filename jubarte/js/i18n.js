/**
 * Internationalization (i18n) Module for Flat Jubarte
...
const translations = {
  pt: {
    ...
    // Hero
    heroTitle: "Bem-vindo ao Flat Jubarte",
    heroSubtitle: "Seu refúgio à beira-mar em Itacaré, Bahia",
    ...
    notice: {
      title: "Você sabia?",
      paragraphs: [
        'A <strong>jubarte</strong> — também conhecida como baleia-jubarte — é famosa pelas suas canções únicas: os machos cantam melodias complexas que podem durar até 20 minutos e se propagar por centenas de quilômetros no oceano. 🐋',
        'Que honra ter um flat com o nome de um ser tão majestoso! Esperamos que sua estadia seja tão memorável quanto o canto de uma jubarte. 🎵🌊'
      ]
    },
    ...
    about: {
      title: "Sobre o Flat",
      desc: [
        "<strong>Flat Jubarte</strong>, localizado em Itacaré, é o refúgio perfeito para quem busca conforto e praticidade. Com uma decoração moderna e acolhedora, o flat oferece uma ampla gama de comodidades para garantir uma estadia agradável.",
    ...
    gallery: {
      title: "Galeria",
      images: [
        { src: "images/apartment/img1.jpg", alt: "Sala de estar do Flat Jubarte" },
        ...
        { src: "images/apartment/img7.jpg", alt: "Vista externa do flat" }
      ]
    },
    ...
    beaches: {
      ...
      items: [
        ...
        { name: "⛵ São José", desc: "Uma jóia escondida! Praia de águas calmas e cristalinas, perfeita para mergulho e dias tranquilos longe da agitação.", image: "images/must-see/saojose.webp" },
      ...
      items: [
        {
          ...
          images: [
            { src: "../maritaca/images/restaurants/Nuuh/logo.jpeg", alt: "Nuuh - Logo" },
            { src: "../maritaca/images/restaurants/Nuuh/peixe-grelhado-com-batatas.jpg", alt: "Nuuh - Peixe grelhado com batatas" },
            { src: "../maritaca/images/restaurants/Nuuh/camaroes-na-mini-moranga.jpg", alt: "Nuuh - Camarões na mini moranga" },
            { src: "../maritaca/images/restaurants/Nuuh/polvo-grelhado-com-pure.jpg", alt: "Nuuh - Polvo grelhado com purê" }
          ],
        ...
        },
        {
          ...
          images: [
            { src: "../maritaca/images/restaurants/esfiharia/logo.png", alt: "Esfiharia Itacaré - Logo" },
            { src: "../maritaca/images/restaurants/esfiharia/1.png", alt: "Esfiharia Itacaré - Esfihas" },
            { src: "../maritaca/images/restaurants/esfiharia/2.png", alt: "Esfiharia Itacaré - Ambiente" }
          ],
    ...
    sports: {
      ...
      items: [
        { name: "🏄 Aula de Surf", desc: "Conecte-se com o mar, desafie seus limites e viva a sensação única de deslizar sobre as ondas. Surf é liberdade, foco e energia.", image: "../maritaca/images/sports/surf/image.png", mapLink: "https://maps.app.goo.gl/xypM3ULvkojkQXhA9", instagram: "https://www.instagram.com/itacare_training_concept/", instagramHandle: "@itacare_training_concept" },
        { name: "🥋 Baruk Jiu-Jitsu", desc: "Descubra o Jiu-Jitsu: mais confiança, força e controle em cada treino. Comece hoje, evolua no tatame e supere seus próprios limites.", image: "../maritaca/images/sports/jiu-jitsu/image.jpg", mapLink: "https://share.google/pJGovUlxQ0rtjn4xz", instagram: "https://www.instagram.com/barukjiujitsu/", instagramHandle: "@barukjiujitsu" },
        { name: "💪 CrossFit", desc: "Treinos intensos, resultados reais e uma comunidade que puxa você para cima. CrossFit é superação diária, dentro e fora do box.", image: "../maritaca/images/sports/crossfit/image.png", mapLink: "https://maps.app.goo.gl/xypM3ULvkojkQXhA9", instagram: "https://www.instagram.com/itacare_training_concept", instagramHandle: "@itacare_training_concept" },
        { name: "🚣 Canoa Havaiana (Outrigger)", desc: "Força, sintonia e espírito de equipe no ritmo do oceano. A canoa havaiana transforma treino em conexão e performance.", image: "../maritaca/images/sports/outrigger/image.png", mapLink: "https://maps.app.goo.gl/xypM3ULvkojkQXhA9", instagram: "https://www.instagram.com/itacare_training_concept", instagramHandle: "@itacare_training_concept" }
      ]
    },
    ...
    // Footer
    footer: {
      copyright: "Flat Jubarte Itacaré. Feito com carinho para você."
    },
  ...
  en: {
    ...
    // Hero
    heroTitle: "Welcome to Flat Jubarte",
    heroSubtitle: "Your oceanfront retreat in Itacaré, Bahia",
    ...
    notice: {
      title: "Did you know?",
      paragraphs: [
        'The <strong>jubarte</strong> — also known as the humpback whale — is famous for its unique songs: males sing complex melodies that can last up to 20 minutes and travel hundreds of kilometers through the ocean. 🐋',
        'How fitting to have a flat named after such a majestic creature! We hope your stay is as memorable as a humpback\'s song. 🎵🌊'
      ]
    },
    ...
    about: {
      ...
      desc: [
        "<strong>Flat Jubarte</strong>, located in Itacaré, is the perfect retreat for those seeking comfort and convenience. With modern and cozy decor, the flat offers a wide range of amenities to ensure a pleasant stay.",
    ...
    gallery: {
      title: "Gallery",
      images: [
        { src: "images/apartment/img1.jpg", alt: "Living room of Flat Jubarte" },
        ...
        { src: "images/apartment/img7.jpg", alt: "External view of the flat" }
      ]
    },
    ...
    beaches: {
      ...
      items: [
        ...
        { name: "⛵ São José", desc: "A hidden gem! Calm, crystal-clear waters perfect for snorkeling and peaceful days away from the crowds.", image: "images/must-see/saojose.webp" },
      ...
      items: [
        {
          ...
          images: [
            { src: "../maritaca/images/restaurants/Nuuh/logo.jpeg", alt: "Nuuh - Logo" },
            { src: "../maritaca/images/restaurants/Nuuh/peixe-grelhado-com-batatas.jpg", alt: "Nuuh - Grilled fish with potatoes" },
            { src: "../maritaca/images/restaurants/Nuuh/camaroes-na-mini-moranga.jpg", alt: "Nuuh - Shrimp in mini pumpkin" },
            { src: "../maritaca/images/restaurants/Nuuh/polvo-grelhado-com-pure.jpg", alt: "Nuuh - Grilled octopus with puree" }
          ],
          mapLink: "https://maps.app.goo.gl/HmY5nLCPUfktjEeu6",
          instagram: "https://www.instagram.com/nuuhbistro",
          instagramHandle: "@nuuhbistro"
        },
        {
          ...
          images: [
            { src: "../maritaca/images/restaurants/esfiharia/logo.png", alt: "Esfiharia Itacaré - Logo" },
            { src: "../maritaca/images/restaurants/esfiharia/1.png", alt: "Esfiharia Itacaré - Esfihas" },
            { src: "../maritaca/images/restaurants/esfiharia/2.png", alt: "Esfiharia Itacaré - Ambiance" }
          ],
          mapLink: "https://maps.app.goo.gl/d8mAqnn4RvoG5tvQ8",
          instagram: "https://www.instagram.com/esfihariaitacare/",
          instagramHandle: "@esfihariaitacare"
    ...
    sports: {
      ...
      items: [
        { name: "🏄 Surf Lessons", desc: "Connect with the sea, challenge your limits, and experience the unique feeling of gliding over waves. Surfing is freedom, focus, and energy.", image: "../maritaca/images/sports/surf/image.png", mapLink: "https://maps.app.goo.gl/xypM3ULvkojkQXhA9", instagram: "https://www.instagram.com/itacare_training_concept/", instagramHandle: "@itacare_training_concept" },
        { name: "🥋 Baruk Jiu-Jitsu", desc: "Discover Jiu-Jitsu: more confidence, strength, and control in every training session. Start today, evolve on the mat, and surpass your own limits.", image: "../maritaca/images/sports/jiu-jitsu/image.jpg", mapLink: "https://share.google/pJGovUlxQ0rtjn4xz", instagram: "https://www.instagram.com/barukjiujitsu/", instagramHandle: "@barukjiujitsu" },
        { name: "💪 CrossFit", desc: "Intense workouts, real results, and a community that pushes you up. CrossFit is daily overcoming, inside and outside the box.", image: "../maritaca/images/sports/crossfit/image.png", mapLink: "https://maps.app.goo.gl/xypM3ULvkojkQXhA9", instagram: "https://www.instagram.com/itacare_training_concept", instagramHandle: "@itacare_training_concept" },
        { name: "🚣 Hawaiian Canoe (Outrigger)", desc: "Strength, harmony, and team spirit to the rhythm of the ocean. Hawaiian canoe transforms training into connection and performance.", image: "../maritaca/images/sports/outrigger/image.png", mapLink: "https://maps.app.goo.gl/xypM3ULvkojkQXhA9", instagram: "https://www.instagram.com/itacare_training_concept", instagramHandle: "@itacare_training_concept" }
      ]
    },
    ...
    // Footer
    footer: {
      copyright: "Flat Jubarte Itacaré. Made with love for you."
    },
  ...
  he: {
    ...
    // Hero
    heroTitle: "ברוכים הבאים לפלט ז'ובארט",
    heroSubtitle: "המפלט שלך מול הים באיטקרה, באהיה",
    ...
    notice: {
      title: "ידעת?",
      paragraphs: [
        'ה<strong>ז\'ובארט</strong> — הלוויתן הגבנון — מפורסם בשיריו הייחודיים: הזכרים שרים מנגינות מורכבות שיכולות להימשך עד 20 דקות ולהתפשט מאות קילומטרים באוקיינוס. 🐋',
        'כמה מרגש לגור בדירה הנושאת שם של יצור כה מלכותי! אנו מקווים שהשהות שלכם תהיה בלתי נשכחת כמו שיר הלוויתן. 🎵🌊'
      ]
    },
    ...
    about: {
      title: "על הדירה",
      desc: [
        "<strong>Flat Jubarte</strong>, הממוקמת באיטאקרה, היא המקום המושלם למי שמחפש נוחות ונעימות. עם עיצוב מודרני וחמים, הדירה מציעה מגוון שירותים שיהפכו את השהות שלכם לנעימה במיוחד.",
    ...
    gallery: {
      title: "גלריה",
      images: [
        { src: "images/apartment/img1.jpg", alt: "סלון של דירת ז'ובארט" },
        ...
        { src: "images/apartment/img7.jpg", alt: "מבט חיצוני של הדירה" }
      ]
    },
    ...
    beaches: {
      ...
      items: [
        ...
        { name: "⛵ סאו ז'וזה", desc: "אבן חן נסתרת! מים שקטים וצלולים מושלמים לצלילה וימים שקטים הרחק מההמון.", image: "images/must-see/saojose.webp" },
      ...
      items: [
        {
          ...
          images: [
            { src: "../maritaca/images/restaurants/Nuuh/logo.jpeg", alt: "נווה - לוגו" },
            { src: "../maritaca/images/restaurants/Nuuh/peixe-grelhado-com-batatas.jpg", alt: "נווה - דג צלוי עם תפוחי אדמה" },
            { src: "../maritaca/images/restaurants/Nuuh/camaroes-na-mini-moranga.jpg", alt: "נווה - שרימפס בדלעת מיני" },
            { src: "../maritaca/images/restaurants/Nuuh/polvo-grelhado-com-pure.jpg", alt: "נווה - תמנון צלוי עם פירה" }
          ],
          mapLink: "https://maps.app.goo.gl/HmY5nLCPUfktjEeu6",
          instagram: "https://www.instagram.com/nuuhbistro",
          instagramHandle: "@nuuhbistro"
        },
        {
          ...
          images: [
            { src: "../maritaca/images/restaurants/esfiharia/logo.png", alt: "אספיהריה איטקרה - לוגו" },
            { src: "../maritaca/images/restaurants/esfiharia/1.png", alt: "אספיהריה איטקרה - אספיהות" },
            { src: "../maritaca/images/restaurants/esfiharia/2.png", alt: "אספיהריה איטקרה - אווירה" }
          ],
          mapLink: "https://maps.app.goo.gl/d8mAqnn4RvoG5tvQ8",
          instagram: "https://www.instagram.com/esfihariaitacare/",
          instagramHandle: "@esfihariaitacare"
    ...
    sports: {
      ...
      items: [
        { name: "🏄 שיעורי גלישה", desc: "התחברו לים, אתגרו את הגבולות שלכם וחוו את התחושה הייחודית של גלישה על הגלים. גלישה היא חופש, ריכוז ואנרגיה.", image: "../maritaca/images/sports/surf/image.png", mapLink: "https://maps.app.goo.gl/xypM3ULvkojkQXhA9", instagram: "https://www.instagram.com/itacare_training_concept/", instagramHandle: "@itacare_training_concept" },
        { name: "🥋 ברוק ג'יו-ג'יטסו", desc: "גלו ג'יו-ג'יטסו: יותר ביטחון, כוח ושליטה בכל אימון. התחילו היום, התפתחו על המזרן והתגברו על הגבולות שלכם.", image: "../maritaca/images/sports/jiu-jitsu/image.jpg", mapLink: "https://share.google/pJGovUlxQ0rtjn4xz", instagram: "https://www.instagram.com/barukjiujitsu/", instagramHandle: "@barukjiujitsu" },
        { name: "💪 קרוספיט", desc: "אימונים אינטנסיביים, תוצאות אמיתיות וקהילה שדוחפת אתכם קדימה. קרוספיט היא התגברות יומית, בתוך ומחוץ לקופסה.", image: "../maritaca/images/sports/crossfit/image.png", mapLink: "https://maps.app.goo.gl/xypM3ULvkojkQXhA9", instagram: "https://www.instagram.com/itacare_training_concept", instagramHandle: "@itacare_training_concept" },
        { name: "🚣 קאנו הוואי (אאוטריגר)", desc: "כוח, הרמוניה ורוח צוות בקצב האוקיינוס. הקאנו ההוואי הופך אימון לחיבור וביצועים.", image: "../maritaca/images/sports/outrigger/image.png", mapLink: "https://maps.app.goo.gl/xypM3ULvkojkQXhA9", instagram: "https://www.instagram.com/itacare_training_concept", instagramHandle: "@itacare_training_concept" }
      ]
    },
    ...
    // Footer
    footer: {
      copyright: "Flat Jubarte Itacaré. נוצר באהבה עבורכם."
    },
